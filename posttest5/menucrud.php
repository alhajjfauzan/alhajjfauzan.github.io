...
<header>    
    ...
    <div class="centerword" style="display: flex; align-items:flex-start">
    <table border=1 style="margin-top: -150px;margin-left: 360px; border-collapse: collapse; position: center; " >
        <thead>
            <tr>
                <th>No</th>
                <th>Nama</th>
    ...
    <a href="tambahkan.php" style="margin-top: -140px; display: inline-block; padding: 10px 20px; background-color: #DCFFB7; border-radius: 6px;">Tambah Data</a>
    </div>
    <footer style="
