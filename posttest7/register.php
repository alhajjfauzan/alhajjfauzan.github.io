...
if (isset($_POST["submit"])) {
    ...
    if ($password === $cpassword) {
        $sqlregis = "SELECT * FROM data_user WHERE fullname= '$fullname'";
        ...
        if (mysqli_num_rows($checkResult) > 0) {
            ...
            $query = "INSERT INTO data_user VALUES('','$emaile','$password','$fullname','$telpon', '$role')";
  ...
  animation: slideIn 0.6s ease-out;">>
    <form action="register.php" method="post" class="karturegister">
        <div class="container">
            ...
            <label for="cpasword"><b>Konfirmasi Password</label>
            <input type="password" name="cpasword" id="cpasword" placeholder="Masukkan Konfirmasi Password" required>
